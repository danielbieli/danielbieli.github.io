<?php 
	...
	$realtime_content = "<div class=\"realtime_online_visitor_holder\"><div class=\"realtime_online_visitor_avatar\"></div><div class=\"realtime_online_visitor_stats\">" . $visitor_ip . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_device . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_os . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_browser . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_country . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_city . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_current_page . "</div><div class=\"realtime_online_visitor_stats\">" . $visitor_referrer_url . "</div></div>"; 
