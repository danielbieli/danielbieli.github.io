<?php
// Anzeige der zip-Dateien im aktuellen Verzeichnis (Dropdown-menü) -> Auswahl -> entpacken im ./ Verzeichnis
//
// --------------------------------------------------------------------------------
...
echo '<center><p><b>Folgende ZIP-Archive können entpackt werden:</b></p>';
echo '<form action="'.$_SERVER['PHP_SELF'].'" method="post"><select name="archive">';
if ($handle = opendir('.')) {
    while (false !== ($file = readdir($handle))) {
        if (preg_match("/.zip$/i", $file)) {      // nur Dateien mit der Endung .zip werden angezeigt - egal ob .zip groß oder klein geschrieben ist
            echo '<option>'.$file.'</option>';
        }
    }
echo '<input type="submit" value="Entpacken">';
...
echo "<center><p><u>Zip Archiv - <b>".$_POST['archive']."</b> - erfolgreich entpackt!</u></p><input type='button' value='Back' onclick='history.go(-1); return false;'></center>";
}
